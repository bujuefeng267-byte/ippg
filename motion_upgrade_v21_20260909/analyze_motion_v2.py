#!/usr/bin/env python3
"""V2.1 offline multi-ROI rPPG with HR derived from the saved fused waveform.
...
def main():
    ...
    summary=dict(version='multi_roi_v2.1',identity=identity,source_hashes=frozen_sources,fps=fps,frames=len(trace),
    ...
    axes[0].set(ylabel='Sampling',ylim=(-.1,1.2),title='V2.1: sampling and offline HR from actual waveforms')
